"""Tests for the **UI component** plugin type (`services/experience/app/ui_component_registry.py`).
Proves manifest registration, activation/deactivation, name conflict checks, and Application Builder integration.
"""
...
def test_unregistered_component_is_rejected_registered_one_is_accepted(jdoe_token: str) -> None:
    ...
    # session (200) or it genuinely isn't yet (400) — both are valid

...
def test_filiale_isolation_across_services(msmith_token: str) -> None:
    ...
    # ObjectTypes are catalogued per tenant (self-serve)
    ...
    status, objects = _request("GET", ontology_url("/objects/Customer"), token=filiale_token)

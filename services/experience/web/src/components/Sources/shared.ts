...
export const SECRET_REF_HELP =
  "e.g. env:HOLON_CONN_<tenant>_ERP_PASSWORD or vault:connectors/<tenant>/db#password — Holon stores the reference, not the secret. In production, env: must use the HOLON_CONN_<tenant>_* prefix.";

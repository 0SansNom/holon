...
import type { GenericSource, SqlSource, ObjectSource, SalesforceSource } from "../../api/connectivity";
  ...
  return (
    <div>
      <OntologyTabHeader
        description={
          <>
            Connect REST, SQL, object storage, Salesforce, Kafka, or registered plugins — no deploy. Synced data is

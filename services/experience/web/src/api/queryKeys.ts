...
export const queryKeys = {
  ...
  sftpConnections: () => ["sftpConnections"] as const,
  sftpSources: () => ["sftpSources"] as const,
  salesforceConnections: () => ["salesforceConnections"] as const,
  salesforceSources: () => ["salesforceSources"] as const,
